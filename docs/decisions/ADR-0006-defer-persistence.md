...
- Statut : **Remplacé** par [ADR-0009 — Comptes Supabase et progression persistante](ADR-0009-account-persistence.md)
...
> [ADR-0009](ADR-0009-account-persistence.md), qui reste soumis à arbitrage humain.
